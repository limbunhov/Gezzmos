                    ...
                    <div class="scroll">
                        <div v-for="cartItem in products" :key="cartItem.productDetail._id" class="shop_p1">
                            ...
                            <div class="details_p1">
                                <h1>{{ cartItem.productDetail.name }}</h1>
                                <p>{{ cartItem.productDetail.title.t1 }}</p>
                                <p>{{ cartItem.productDetail.title.t2 }}</p>
                                <p>{{ cartItem.productDetail.title.t3 }}</p>
    ...
    methods: {
        ...
        async remove_product(productId) {
            ...
            try {
                ...
                await axios.delete(`https://colorful-dog-teddy.cyclic.app/cart/${userId}/${productId}`);
        ...
        async clearall() {
            try {
                ...
                await axios.delete(`https://colorful-dog-teddy.cyclic.app/cart/${userId}`);
        ...
        async updateCartItemQuantity(productId, quantity) {
            try {
                const userId = localStorage.getItem("userId");
                await axios.put(`https://colorful-dog-teddy.cyclic.app/cart/${userId}/${productId}`, { quantity });
