  ...
  methods: {
    async fetchOrders() {
      try {
        ...
        const response = await axios.get('https://colorful-dog-teddy.cyclic.app/orderedItems');
    ...
    async approveOrder(orderId) {
      try {
        ...
        await axios.put(`https://colorful-dog-teddy.cyclic.app/orders/${orderId}/status`, {
          status: 'approved',
